...
let s:colors = {
      ...
      \ "diffAdd": get(s:overrides, "diffAdd", {"gui": "#043B42", "cterm": "23" }),
      \ "diffAddText": get(s:overrides, "diffAddText", {"gui": "#35B37E", "cterm": "108" }),
      \ "diffDel": get(s:overrides, "diffDel", {"gui": "#502127", "cterm": "168" }),
      \ "diffDelText": get(s:overrides, "diffDelText", {"gui": "#IFF8F7", "cterm": "210" }),
      \ "diffChange": get(s:overrides, "diffChange", {"gui": "#04133A", "cterm": "16" }),
      \ "diffChangeText": get(s:overrides, "diffChangeText", {"gui": "#61AFEF", "cterm": "39" }),
      \}
